  ...
  render() {
    return (
      <>
        ...
        <Flex minH="100vh" overflow="hidden">
          <Box mt="1rem">
            <SimpleGrid columns={2} spacing={20} p="1rem">
              <Box
                as="span"
                fontFamily="mono"
                fontWeight="600"
              ...
              >
                service 1:
                <Button ml="10px">artwork generator</Button>
                <Text>Easy To Use</Text>
                <Text>
                  No coding required. Create your layers, import your assets and
                  generate artwork!
                </Text>
              </Box>
              <Box
              ...
              >
                service 2:
                <Button ml="10px">collection dispenser</Button>
              </Box>
            </SimpleGrid>
          </Box>
        </Flex>
        ...
        <Flex minH="100vh" overflow={"hidden"}>
          <Box width={{ xl: "75%" }}>
            <Grid templateRows="repeat(10, 1fr)" h={"100%"}>
              <GridItem bg="white" rowSpan={5}>
                <Grid h={"100%"} templateColumns="repeat(7, 1fr)" gap={0}>
                  <GridItem colSpan={4}>
                    <Flex
                      h="100%"
                      paddingTop={"50px"}
                    ...
                    >
                      ...
                      >
                        A no-code solution for artwork generation, decentralized
                        storage & distribution of NFTs
                      </Box>
                      <Text
                        color="#2F4F4F"
                        fontSize={{
                      ...
                      >
                        Empowering artist by bridging the gap between artist and
                        technology
                      </Text>
                      <HStack marginTop={"15px"}>
                        ...
                        <Button
                          bg="#F0F8FF"
                          leftIcon={<AiOutlineMedium size={25} />}
                          h="40px"
                          border="1px"
                          borderColor="black"
                          width="140px"
                  ...
                  >
                    <Box>
                      ...
                      <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube.com/embed/AKQmBX1JLU4"
                  ...
                  >
                    ...
                    <Box textAlign={"center"}>
                      <ButtonGroup variant="ghost" spacing="20" color="#2F4F4F">
                        <Button
                          colorScheme="purple"
                          isActive={this.state.featureone}
                        ...
                        <Button
                          colorScheme="purple"
                          isActive={this.state.featuretwo}
                              ...
                              <Flex>
                                ...
                                <Box flex="1" textAlign="center">
                                  ...
                                  <Text
                                    ...
                                    marginLeft={"10px"}
                                  >
                                    No coding required. Create your layers,
                                    import your assets, click Generate and you
                                    are done!
                                  </Text>
                                </Box>
                              </Flex>
                              ...
                              <Flex>
                                ...
                                <Box flex="1" textAlign="center">
                                  ...
                                  <Text
                                    ...
                                    marginLeft={"10px"}
                                  >
                                    You can import images and gifs and we will
                                    generate your collection in the specific
                                    format.
                                  </Text>
                                </Box>
                              </Flex>
                              ...
                              <Flex>
                                ...
                                <Box flex="1" textAlign="center">
                                  ...
                                  <Text
                                    ...
                                    marginLeft={"10px"}
                                  >
                                    Easily configure certain layers and
                                    attributes to be more rare than others.
                                  </Text>
                                </Box>
                              </Flex>
                            </Box>
                              ...
                              <Flex>
                                ...
                                <Box flex="1" textAlign="center">
                                  ...
                                  <Text
                                    ...
                                    marginLeft={"10px"}
                                  >
                                    Customize and Deploy a smart contract to
                                    ICON for every art collection of yours!
                                  </Text>
                                </Box>
                              </Flex>
                            </Box>
                              ...
                              <Flex>
                                ...
                                <Box flex="1" textAlign="center">
                                  ...
                                  <Text
                                    ...
                                    marginLeft={"10px"}
                                  >
                                    Just like Wix, create and configure your
                                    very own dApp to sell your collection.
                                  </Text>
                                </Box>
                              </Flex>
                            </Box>
                              ...
                              <Flex>
                                ...
                                <Box flex="1" textAlign="center">
                                  <Text
                                    ...
                                    marginRight={"20px"}
                                  >
                                    Bulk Minting from your Collection{" "}
                                  </Text>
                                  <Text
                                    color="#2F4F4F"
                                    fontSize={{ one: "12px", five: "14px" }}
                                    ...
                                    marginLeft={"10px"}
                                  >
                                    Market your generated dApp and allow users
                                    around the world to bulk mint your
                                    collection!
                                  </Text>
                                </Box>
                              </Flex>
          ...
          <Box width={{ xl: "25%" }} bg="#202225" opacity="97%" color="white">
            <Box
              position={"relative"}
              margin={0}
              top={"45%"}
            ...
            >
              ...
              <Box my="20px">
                <label for="wallet" className="mb-2">
                  Wallet:
                </label>
                <Select placeholder="Select option" name="wallet" mb="10px">
                  <option value="icon_wallet" selected>
                    ICON Wallet
                  </option>
                </Select>
              </Box>
