        ...
        return (
            <div id="usergallery">
                    ...
                    {this.mintedindex.map((data, index) => (
                        <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                            ...
                            <a target="_blank" onClick={() => this.setState({
                                showAdvancedSettings: true, modaltitle: this.state.thumbnailFiles[data].name
                ...
                <Modal
                    ...
                    <ModalContent>
                        <ModalHeader
                            borderBottom='2px' borderColor='black.200' textAlign={"center"}>{this.state.modaltitle}</ModalHeader>
                        <ModalCloseButton />
                            ...
                            <Flex>
                                <Box boxSize='xl' >
                                    ...
                                    <Box marginTop={"10px"} textAlign={"center"}>
                                        <Link fontSize={"20px"} marginBottom={"5px"} color='black' display={"block"} _hover={{
                                            background: "white",
                                            color: "#2F4F4F",
                                        }}>View on Sejong</Link>
                                        <Link fontSize={"20px"} marginBottom={"5px"} color='black' display={"block"} _hover={{
                                        ...
                                        <Link fontSize={"20px"} marginBottom={"5px"} color='black' _hover={{
                                            background: "white",
                                            color: "#2F4F4F",
                                        }}>View on IPFS</Link>
                                    </Box>
                                ...
                                <Box marginLeft={"40px"}>
                                    ...
                                    <Text fontSize={"25px"} color={"#2F4F4F"} marginBottom={"8px"}>{this.wallet_address}</Text>
                                    <Box textStyle='h1' marginBottom={"3px"}>Contract</Box>
                                    <Text fontSize={"25px"} color={"#2F4F4F"} marginBottom={"8px"}>{this.contract_address}</Text>
                                    <Box textStyle='h1' marginBottom={"10px"}>Attributes</Box>
